...
class TestPromptLoader(unittest.TestCase):
    ...
    @patch("src.utils.prompt_loader.os.path.exists")
    @patch("src.utils.prompt_loader.open", new_callable=mock_open, read_data="Column Classification System Prompt")
    ...
    @patch("src.utils.prompt_loader.os.path.exists")
    @patch("src.utils.prompt_loader.open", new_callable=mock_open, read_data="Feature Encoding System Prompt")
    ...
    @patch("src.utils.prompt_loader.os.path.exists")
    @patch("src.utils.prompt_loader.open", new_callable=mock_open, read_data="Model Configurator System Prompt")
